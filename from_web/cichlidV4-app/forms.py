...
class EnterDataForm(FlaskForm):
 ...
 sp_taxpos = SelectField('Taxon position :', choices = [('unk', '-select-'), ('species', 'species'), ('order', 'order'), ('class', 'class'), ('family', 'family'), ('genus', 'genus'), ('phylum', 'phylum'), ('kingdom', 'kindom')])
 ...
 loc_collected = StringField('Date collected (YYYY-MM-DD): ', validators = (validators.Optional(),))
 ...
 file_length=StringField('Average read length: ' , [validators.Optional()])
